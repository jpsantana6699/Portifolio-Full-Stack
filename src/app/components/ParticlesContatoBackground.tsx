...
export function ParticlesContatoBackground() {
    ...
    () => ({
      ...
      interactivity: {
        ...
        events: {
          ...
          onDiv: { selectors: [], enable: false, mode: [], type: 'circle' as const },
      ...
      particles: {
        ...
        color: {
          value: '#fff',
          animation: {
            h: { count: 0, enable: false, speed: 20, decay: 0, delay: 0, sync: true, offset: 0 },
        ...
        move: {
          ...
          outModes: { default: 'out' as const, bottom: 'out' as const, left: 'out' as const, right: 'out' as const, top: 'out' as const },
          random: false,
          size: false,
          speed: 5,
        ...
        opacity: {
          value: 1,
          animation: {
            count: 0, enable: false, speed: 2, decay: 0, delay: 0, sync: false, mode: 'auto', startValue: 'random', destroy: 'none',
          },
        },
        reduceDuplicates: false,
        shadow: { blur: 0, color: { value: '#000' }, enable: false, offset: { x: 0, y: 0 } },
        shape: { close: true, fill: true, options: {}, type: 'circle' as const },
        size: {
          value: 3,
          animation: {
